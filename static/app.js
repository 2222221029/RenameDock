const state = {
  ...
  previewPage: 0, previewPageSize: 100,
};
...
function applyTheme(theme) {
  ...
  $$("[data-theme-toggle]").forEach(button => {
    button.querySelector("[data-theme-icon]").textContent = light ? "â˜¾" : "â˜€";
